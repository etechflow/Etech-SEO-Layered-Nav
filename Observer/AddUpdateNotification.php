...
{
    private const PACKAGE     = 'etechflow/module-seo-layered-nav';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-seo-layered-nav.json';
    private const CACHE_KEY   = 'etechflow_sln_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'ETechFlow_SeoLayeredNav';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow SEO Layered Nav %1 is available', $latest['version']);
